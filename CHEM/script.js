...
function result_3(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(m3)*4)+(Number(eca)*4)+(Number(emf)*4)+(Number(edc)*4)+(Number(em1)*2)+(Number(ss)*1.5)+(Number(minor)*4) ) / 23.5
    }else{
        var Result = ( (Number(m3)*4)+(Number(eca)*4)+(Number(emf)*4)+(Number(edc)*4)+(Number(em1)*2)+(Number(ss)*1.5) ) / 19.5
    }
...
function result_4(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(bfe)*4)+(Number(ae)*4)+(Number(pdc)*3)+(Number(em2)*4)+(Number(dsoop)*4)+(Number(el_lab_2)*3)+(Number(em_lab_2)*1.5)+(Number(minor)*4) ) / 27.5
    }
    else{
        var Result = ( (Number(bfe)*4)+(Number(ae)*4)+(Number(pdc)*3)+(Number(em2)*4)+(Number(dsoop)*4)+(Number(el_lab_2)*3)+(Number(em_lab_2)*1.5) ) / 23.5
    }
...
function result_5(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(adc)*4)+(Number(pe)*4)+(Number(mi)*3)+(Number(td)*3)+(Number(cs)*3)+(Number(iem)*1.5)+(Number(el_lab_3)*2)+(Number(mc_lab)*3)+(Number(minor)*4) ) / 27.5
    }else{
        var Result = ( (Number(adc)*4)+(Number(pe)*4)+(Number(mi)*3)+(Number(td)*3)+(Number(cs)*3)+(Number(iem)*1.5)+(Number(el_lab_3)*2)+(Number(mc_lab)*3) ) / 23.5
    }
...
function result_6(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(psa)*4)+(Number(mm)*4)+(Number(pe1)*3)+(Number(pe2)*3)+(Number(entre)*3)+(Number(mm_lab)*1.5)+(Number(pe_lab)*3)+(Number(minor)*4) ) / 25.5
    }else{
        var Result = ( (Number(psa)*4)+(Number(mm)*4)+(Number(pe1)*3)+(Number(pe2)*3)+(Number(entre)*3)+(Number(mm_lab)*1.5)+(Number(pe_lab)*3) ) / 21.5
    }
...
function result_7(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(psoc)*4)+(Number(ps)*4)+(Number(ssd)*4)+(Number(pe3)*3)+(Number(pe4)*3)+(Number(pe5)*1.5)+(Number(ps_lab)*1)+(Number(minor)*4) ) / 24.5
    }else{
        var Result = ( (Number(psoc)*4)+(Number(ps)*4)+(Number(ssd)*4)+(Number(pe3)*3)+(Number(pe4)*3)+(Number(pe5)*1.5)+(Number(ps_lab)*1)) / 20.5
    }
