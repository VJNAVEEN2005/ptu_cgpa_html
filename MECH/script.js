...
function result_3(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(m3)*4)+(Number(eca)*4)+(Number(emf)*4)+(Number(edc)*4)+(Number(em1)*3)+(Number(ss)*3)+(Number(minor)*4) ) / 26
    }else{
        var Result = ( (Number(m3)*4)+(Number(eca)*4)+(Number(emf)*4)+(Number(edc)*4)+(Number(em1)*3)+(Number(ss)*3) ) / 22
    }
...
function result_4(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(bfe)*2)+(Number(ae)*3)+(Number(pdc)*4)+(Number(em2)*4)+(Number(dsoop)*3)+(Number(el_lab_2)*4)+(Number(em_lab_2)*1.5)+(Number(minor)*4) ) / 25.5
    }
    else{
        var Result = ( (Number(bfe)*2)+(Number(ae)*3)+(Number(pdc)*4)+(Number(em2)*4)+(Number(dsoop)*3)+(Number(el_lab_2)*4)+(Number(em_lab_2)*1.5) ) / 21.5
    }
...
function result_5(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(adc)*4)+(Number(pe)*4)+(Number(mi)*4)+(Number(td)*3)+(Number(cs)*3)+(Number(iem)*1.5)+(Number(el_lab_3)*3)+(Number(minor)*4) ) / 26.5
    }else{
        var Result = ( (Number(adc)*4)+(Number(pe)*4)+(Number(mi)*4)+(Number(td)*3)+(Number(cs)*3)+(Number(iem)*1.5)+(Number(el_lab_3)*3) ) / 22.5
    }
...
function result_6(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(psa)*3)+(Number(mm)*4)+(Number(pe1)*4)+(Number(pe2)*4)+(Number(entre)*3)+(Number(mm_lab)*1)+(Number(pe_lab)*1.5)+(Number(oec)*3)+(Number(minor)*4) ) / 27.5
    }else{
        var Result = ( (Number(psa)*3)+(Number(mm)*4)+(Number(pe1)*4)+(Number(pe2)*4)+(Number(entre)*3)+(Number(mm_lab)*1)+(Number(pe_lab)*1.5)+(Number(oec)*3) ) / 23.5
    }
...
function result_7(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(psoc)*4)+(Number(ps)*3)+(Number(ssd)*4)+(Number(pe3)*3)+(Number(pe4)*3)+(Number(pe5)*2)+(Number(minor)*4) ) / 23
    }else{
        var Result = ( (Number(psoc)*4)+(Number(ps)*3)+(Number(ssd)*4)+(Number(pe3)*3)+(Number(pe4)*3)+(Number(pe5)*2)) / 19
    }
