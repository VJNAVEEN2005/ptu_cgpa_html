...
function result_3(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(m3)*2)+(Number(eca)*4)+(Number(emf)*2)+(Number(edc)*3)+(Number(em1)*3)+(Number(ss)*3)+(Number(el_lab_1)*1.5)+(Number(em_lab_1)*1.5)+(Number(minor)*4) ) / 24
    }else{
        var Result = ( (Number(m3)*2)+(Number(eca)*4)+(Number(emf)*2)+(Number(edc)*3)+(Number(em1)*3)+(Number(ss)*3)+(Number(el_lab_1)*1.5)+(Number(em_lab_1)*1.5) ) / 20
    }
...
function result_4(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(bfe)*4)+(Number(ae)*3)+(Number(pdc)*3)+(Number(em2)*3)+(Number(dsoop)*3)+(Number(el_lab_2)*4)+(Number(em_lab_2)*1.5)+(Number(dsoop_lab)*1.5)+(Number(minor)*4) ) / 27
    }
    else{
        var Result = ( (Number(bfe)*4)+(Number(ae)*3)+(Number(pdc)*3)+(Number(em2)*3)+(Number(dsoop)*3)+(Number(el_lab_2)*4)+(Number(em_lab_2)*1.5)+(Number(dsoop_lab)*1.5) ) / 23
    }
...
function result_5(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(adc)*4)+(Number(pe)*3)+(Number(mi)*3)+(Number(td)*4)+(Number(cs)*3)+(Number(iem)*1.5)+(Number(el_lab_3)*1.5)+(Number(mc_lab)*2)+(Number(oec)*3)+(Number(minor)*4) ) / 29
    }else{
        var Result = ( (Number(adc)*4)+(Number(pe)*3)+(Number(mi)*3)+(Number(td)*4)+(Number(cs)*3)+(Number(iem)*1.5)+(Number(el_lab_3)*1.5)+(Number(mc_lab)*2)+(Number(oec)*3) ) / 25
    }
...
function result_6(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(psa)*4)+(Number(mm)*4)+(Number(pe1)*3)+(Number(pe2)*3)+(Number(entre)*3)+(Number(mm_lab)*1.5)+(Number(pe_lab)*1.5)+(Number(oec)*3)+(Number(minor)*4) ) / 27
    }else{
        var Result = ( (Number(psa)*4)+(Number(mm)*4)+(Number(pe1)*3)+(Number(pe2)*3)+(Number(entre)*3)+(Number(mm_lab)*1.5)+(Number(pe_lab)*1.5)+(Number(oec)*3) ) / 23
    }
...
function result_7(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(psoc)*3)+(Number(ps)*3)+(Number(ssd)*3)+(Number(pe3)*3)+(Number(pe4)*3)+(Number(pe5)*1.5)+(Number(ps_lab)*1)+(Number(minor)*4) ) / 21.5
    }else{
        var Result = ( (Number(psoc)*3)+(Number(ps)*3)+(Number(ssd)*3)+(Number(pe3)*3)+(Number(pe4)*3)+(Number(pe5)*1.5)+(Number(ps_lab)*1)) / 17.5
    }
