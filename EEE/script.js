...
function result_3(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(m3)*4)+(Number(eca)*4)+(Number(emf)*3)+(Number(edc)*3)+(Number(em1)*3)+(Number(ss)*3)+(Number(el_lab_1)*1.5)+(Number(em_lab_1)*1.5)+(Number(minor)*4) ) / 27
    }else{
        var Result = ( (Number(m3)*4)+(Number(eca)*4)+(Number(emf)*3)+(Number(edc)*3)+(Number(em1)*3)+(Number(ss)*3)+(Number(el_lab_1)*1.5)+(Number(em_lab_1)*1.5) ) / 23
    }
...
function result_4(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(bfe)*2)+(Number(ae)*3)+(Number(pdc)*3)+(Number(em2)*3)+(Number(dsoop)*3)+(Number(el_lab_2)*1.5)+(Number(em_lab_2)*1.5)+(Number(dsoop_lab)*1.5)+(Number(minor)*4) ) / 22.5
    }
    else{
        var Result = ( (Number(bfe)*2)+(Number(ae)*3)+(Number(pdc)*3)+(Number(em2)*3)+(Number(dsoop)*3)+(Number(el_lab_2)*1.5)+(Number(em_lab_2)*1.5)+(Number(dsoop_lab)*1.5) ) / 18.5
    }
...
function result_5(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(adc)*3)+(Number(pe)*3)+(Number(mi)*3)+(Number(td)*3)+(Number(cs)*4)+(Number(iem)*3)+(Number(el_lab_3)*1.5)+(Number(mc_lab)*1.5)+(Number(oec)*3)+(Number(minor)*4) ) / 29
    }else{
        var Result = ( (Number(adc)*3)+(Number(pe)*3)+(Number(mi)*3)+(Number(td)*3)+(Number(cs)*4)+(Number(iem)*3)+(Number(el_lab_3)*1.5)+(Number(mc_lab)*1.5)+(Number(oec)*3) ) / 25
    }
...
function result_6(){
    ...
    if(localStorage.getItem("hm") == "minor" || localStorage.getItem("hm") == "honor"){
        var Result = ( (Number(psa)*4)+(Number(mm)*3)+(Number(pe1)*3)+(Number(pe2)*3)+(Number(entre)*2)+(Number(mm_lab)*1.5)+(Number(pe_lab)*1.5)+(Number(oec)*3)+(Number(minor)*4) ) / 25
    }else{
        var Result = ( (Number(psa)*4)+(Number(mm)*3)+(Number(pe1)*3)+(Number(pe2)*3)+(Number(entre)*2)+(Number(mm_lab)*1.5)+(Number(pe_lab)*1.5)+(Number(oec)*3) ) / 21
    }
